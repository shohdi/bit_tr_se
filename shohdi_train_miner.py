...
from shohdi_lib.BitCoinEnv import BitCoinEnv
...
if __name__ == "__main__":
    params = common.HYPERPARAMS['bitcoin']
    ...
    env = BitCoinEnv() # gym.make(params['env_name'])
    ...
    with common.RewardTracker(writer, params['stop_reward']) as reward_tracker:
        while True:
            ...
            loss_v,_ = calc_loss(batch, net, tgt_net.target_model,
            ...
            if frame_idx % CHECKPOINT_EVERY_STEP == 0:
                idx1 = frame_idx // CHECKPOINT_EVERY_STEP
                torch.save(net.state_dict(), os.path.join("save", "checkpoint-%3d.data" % idx1))
